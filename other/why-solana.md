...
The gas fee of Solana is really low so we will use some swap program from other great project and swap it to what's the highest reward's pool need and we are also planning to be a Solana Validator too so SOL might be a better choice. 
