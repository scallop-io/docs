...
You can get the list package address of scallops using this endpoint:
...
```json
{
    ...
    "memo": "main address contract(for native) on app.scallop.io 22/05/2024",
    "createdAt": "Sun Sep 29 2024 04:09:37 GMT+0000 (Coordinated Universal Time)",
    "updatedAt": "Mon Oct 21 2024 14:55:44 GMT+0000 (Coordinated Universal Time)",
    "version": 0,
    "id": "66f8e7ed9bb9e07fdfb86bbb"
}
```
{% endcode %}
{% endtab %}
